...
const FlightLanding = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError('Failed to register flight landing. Please try again.');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <PageTemplate 
      ...
      description="Register the landing of an incoming flight"
    >
      {success && (
        <div className="mb-6 bg-green-50 border border-green-200 text-green-700 px-4 py-3 rounded flex items-center">
          ...
          <span>Flight landing registered successfully!</span>
        </div>
      )}
