...
export default function PassengersDisembark() {
  ...
  useEffect(() => {
    document.title = 'Passengers Disembark';
  }, []);
  ...
  const handleSubmit = async (e) => {
    ...
    setIsError(false);
    try {
      const res = await fetch(`${API_BASE_URL}/procedures/passengers_disembark`, {
        method: 'POST',
  ...
  return (
    <PageTemplate title="Passengers Disembark">
      <div style={{ maxWidth: 400, margin: '40px auto', padding: 16 }}>
        <h2 style={{ marginBottom: 16 }}>Passengers Disembark</h2>
