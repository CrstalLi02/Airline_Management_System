...
const FlightsOnTheGround = () => {
      ...
      try {
        ...
        const mockData = [
          { 
            ...
            num_flights: 1,
            flight_list: 'nk_98',
            earliest_arrival: '13:13:13',
            latest_arrival: '13:13:13',
            airplane_list: 'plane_27'
          },
          { 
            departing_from: 'ICN', 
            num_flights: 1,
            flight_list: 'ke_64',
            earliest_arrival: '16:00:00',
            latest_arrival: '16:00:00',
            airplane_list: 'plane_4'
          }
        ];
  ...
  if (loading) {
    return (
      <PageTemplate 
        title="Flights on the Ground" 
        description="Monitor flights currently on the ground"
      >
  ...
  return (
    ...
    >
      <div className="bg-white rounded-lg shadow-md p-6">
        <h2 className="text-2xl font-bold text-gray-800 mb-4">View: Flights on the Ground</h2>
        <p className="text-lg text-gray-600 mb-6 font-medium">flights_on_the_ground()</p>
        ...
        {flightGroups.length === 0 && (
          <div className="text-center py-8">
            ...
            <p className="text-gray-500">No flights found on the ground</p>
          </div>
        )}
      </div>
    </PageTemplate>
